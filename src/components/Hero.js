...
const Hero = () => {
  return (
    <section id="hero" className="h-screen flex flex-col justify-center items-center bg-nord6 text-nord0 dark:bg-nord3 dark:text-nord4">
      <h2 className="text-4xl md:text-6xl font-bold mb-4">Hello, I'm Nhat Minh</h2>
